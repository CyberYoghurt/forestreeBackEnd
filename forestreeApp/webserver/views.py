...
class WoodPage(APIView):
    ...
    def get(self,request):
        try:
            ...
            woods_serializer = WoodListSerializer(woods_of_page.object_list,many=True)
            response = {
...
class MachineryPage(APIView):
    ...
    def get(self,request):
        try:
            ...
            machinery_serializer = MachineryListSerializer(machineries_of_page.object_list,many=True)
            response = {
...
class WoodInfo(APIView):
    ...
    def delete(self,request):
        print('delete wood info reached')
        id = request.data['id']
...
class Shop(APIView):
    ...
    def get(self, request):
        try:
            ...
            product_serialized = ProductListSerializer(products.object_list,many=True)
            response = {
...
class CheckOut(APIView):
    ...
    def post(self,request):
        print('receiving checkout request')
        try:
            info = (request.data)
            total_price = 0;
            for item in info:
                total_price += (float(item['price']) - (float(item['price']) * float(item['discount']))) * float(item['quantity'])
...
class ChatInfo(APIView):
    ...
    def post(self,request):
        ...
        try:
            ...
            print(Chat.objects.all()[0].users.all())
...
class ManageUser(APIView):
    ...
    def get(self,request):
        ...
        machineries_serialized = UserMachinerySerializer(machineries,many=True)
